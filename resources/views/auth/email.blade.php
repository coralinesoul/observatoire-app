...
@section("content")
    <div class="flex justify-center h-dvh p-10">
        <form class="w-1/2 flex flex-col items-center" action="{{ route('password.email') }}" method="post">
            @csrf
            <div class="w-full">
            ...
            <button class="mt-4 hover:shadow-md rounded-md bg-blue2 py-3 px-8 text-center text-base font-semibold text-white outline-none">Envoyer le lien de réinitialisation</button>
